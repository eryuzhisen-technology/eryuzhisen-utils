...
public class RandomHanUtil {
    ...
    public static synchronized String getRandomHan() throws InterruptedException {
        Thread.sleep(1);
        Random ran = new Random(System.currentTimeMillis());
        int count = ran.nextInt(2)+2;
        StringBuffer hans = new StringBuffer();
        for(int i=0;i<count;i++) {
            hans.append(han.charAt(ran.nextInt(han.length())));
        }
    ...
    public static void main(String[] args) {
        try {
            for(int i =0;i<10000;i++) {
                System.out.println(RandomHanUtil.getRandomHan());
            }
